  ...
  return (
    <div className={styles.sidebar}>
      {isAdmin ?
        ...
        :
        <>
          <NavLink className={styles.link} activeClassName={styles.link__active} to="/my-lessons">Мои уроки</NavLink>
          <NavLink className={styles.link} activeClassName={styles.link__active} to="/my-groups">Мои группы</NavLink>
        </>
      }
    </div>
  )
